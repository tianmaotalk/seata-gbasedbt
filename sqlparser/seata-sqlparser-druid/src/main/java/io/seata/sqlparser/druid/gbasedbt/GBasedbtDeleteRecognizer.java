...
/**
 * The type gbase8s delete recognizer.
 *
 * @author tianmaotalk
 */
public class GBasedbtDeleteRecognizer extends BaseGBasedbtRecognizer implements SQLDeleteRecognizer {

    private final GBasedbtDeleteStatement ast;
     ...
     * @param ast         the ast
     */
    public GBasedbtDeleteRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
        this.ast = (GBasedbtDeleteStatement)ast;
    }
