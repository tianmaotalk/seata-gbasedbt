...
/**
 * The type gbase8s insert recognizer.
 *
 * @author tianmaotalk
 */
public class GBasedbtInsertRecognizer extends BaseGBasedbtRecognizer implements SQLInsertRecognizer {

    private final GBasedbtInsertStatement ast;
     ...
     * @param ast         the ast
     */
    public GBasedbtInsertRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
        this.ast = (GBasedbtInsertStatement)ast;
    }
