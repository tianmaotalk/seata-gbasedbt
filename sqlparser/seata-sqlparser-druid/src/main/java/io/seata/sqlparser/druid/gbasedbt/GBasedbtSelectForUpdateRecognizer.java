...
/**
 * The type gbase8s select for update recognizer.
 *
 * @author tianmaotalk
 */
public class GBasedbtSelectForUpdateRecognizer extends BaseGBasedbtRecognizer implements SQLSelectRecognizer {
     ...
     * @param ast         the ast
     */
    public GBasedbtSelectForUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
