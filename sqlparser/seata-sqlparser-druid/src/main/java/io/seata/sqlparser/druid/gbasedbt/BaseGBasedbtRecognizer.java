 ...
 * @author tianmaotalk
 */
public abstract class BaseGBasedbtRecognizer extends BaseRecognizer {
     ...
     */
    public BaseGBasedbtRecognizer(String originalSql) {
        super(originalSql);
    }

    public GBasedbtOutputVisitor createOutputVisitor(final ParametersHolder parametersHolder,
                                                   final ArrayList<List<Object>> paramAppenderList,
                                                   final StringBuilder sb) {

        return new GBasedbtOutputVisitor(sb) {
            @Override
    ...
    public String getWhereCondition(SQLExpr where) {
        ...
        StringBuilder sb = new StringBuilder();
        executeVisit(where, new GBasedbtOutputVisitor(sb));
        return sb.toString();
    }
}
